...
CampoF = pygame.image.load(os.path.join("assets","img","campo.png")).convert_alpha()
CampoF = pygame.transform.scale(CampoF,(125,100))
CampoF.set_alpha(60)
...
campRec = CampoF.get_rect(center=(500,500))
